...
\begin{table}[!htbp]
  ...
  \resizebox{\columnwidth}{!}{%
    \begin{tabular}{@{}lcccccc@{}}
      ...
      Speed-limit violation & 144 & $0.1508$ & $\bm{0.2288}$ & $-0.0780$ & $[-0.2986, +0.1219]$ & 0.814 \\
      Abnormal dwell & 1{,}154 & $\bm{0.9381}$ & $0.9307$ & $+0.0074$ & $[-0.0084, +0.0268]$ & 0.814 \\
      Signal freeze & 62 & $0.0261$ & $\bm{0.0848}$ & $-0.0587$ & $[-0.1238, -0.0065]$ & 0.129 \\ \bottomrule
    \end{tabular}}
\end{table}
