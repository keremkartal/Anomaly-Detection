...
\begin{table}[!htbp]
  \centering
  \caption{Encoder benchmark, five seeds, identical protocol. The $p$-values are paired McNemar tests against the LSTM--GAT row; Table~\ref{tab:trip_level} repeats them at the trip level.}
